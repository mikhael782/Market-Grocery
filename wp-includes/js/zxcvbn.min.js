    ...
    return (function e(t, n, r) {
        ...
        2: [function(require, module, exports) {
            ...
            feedback = {
                ...
                get_feedback: function(e, s) {
                    ...
                    r = i.length; t < r; t++)
                        o = i[t],
                        o.token.length > n.token.length && (n = o);
                    return feedback = this.get_match_feedback(n, 1 === s.length),
                    a = "Add another word or two. Uncommon words are better.",
                    null != feedback ? (feedback.suggestions.unshift(a),
                    null == feedback.warning && (feedback.warning = "")) : feedback = {
                        warning: "",
                        suggestions: [a]
                    },
                    feedback
                ...
                get_match_feedback: function(e, s) {
                    ...
                    case "spatial":
                        return a = e.graph.toUpperCase(),
                        t = 1 === e.turns ? "Straight rows of keys are easy to guess" : "Short keyboard patterns are easy to guess",
                        {
                            warning: t,
                ...
                get_dictionary_match_feedback: function(e, s) {
                    var a, t, r, n, o;
                    return n = "passwords" === e.dictionary_name ? !s || e.l33t || e.reversed ? e.guesses_log10 <= 4 ? "This is similar to a commonly used password" : void 0 : e.rank <= 10 ? "This is a top-10 common password" : e.rank <= 100 ? "This is a top-100 common password" : "This is a very common password" : "english" === e.dictionary_name ? s ? "A word by itself is easy to guess" : void 0 : "surnames" === (a = e.dictionary_name) || "male_names" === a || "female_names" === a ? s ? "Names and surnames by themselves are easy to guess" : "Common names and surnames are easy to guess" : "",
                    r = [],
                    o = e.token,
                    o.match(scoring.START_UPPER) ? r.push("Capitalization doesn't help very much") : o.match(scoring.ALL_UPPER) && o.toLowerCase() !== o && r.push("All-uppercase is almost as easy to guess as all-lowercase"),
        ...
        4: [function(require, module, exports) {
            ...
            zxcvbn = function(e, t) {
                ...
                c = t.length; n < c; n++)
                    i = t[n],
                    "string" != (m = typeof i) && "number" !== m && "boolean" !== m || u.push(rot_13(i.toString().toLowerCase()));
                ...
                for (s in r)
                    _ = r[s],
                    o[s] = _;
                return o.feedback = feedback.get_feedback(o.score, o.sequence),
                o
            }
            ,
        ...
        5: [function(require, module, exports) {
            ...
            matching = {
                ...
                omnimatch: function(e) {
                    var t, n, r, i, a;
                    for (i = [],
                    r = [this.dictionary_match, this.reverse_dictionary_match, this.l33t_match, this.spatial_match, this.repeat_match, this.sequence_match, this.regex_match, this.date_match],
                    a = 0,
                    t = r.length; a < t; a++)
                        n = r[a],
                        this.extend(i, n.call(this, e));
                ...
                dictionary_match: function(e, t) {
                    ...
                    for (n in t)
                        for (l = t[n],
                        r = o = 0,
                        _ = a; 0 <= _ ? o < _ : o > _; r = 0 <= _ ? ++o : --o)
                            for (i = h = f = r,
                            d = a; f <= d ? h < d : h > d; i = f <= d ? ++h : --h)
                                u.slice(r, +i + 1 || 9e9)in l && (p = u.slice(r, +i + 1 || 9e9),
                                c = l[p],
                                s.push({
                                    pattern: "dictionary",
                                    i: r,
                ...
                reverse_dictionary_match: function(e, t) {
                    var n, r, i, a, s, o;
                    for (null == t && (t = RANKED_DICTIONARIES),
                        ...
                        if (t.length) {
                            ...
                            h = d.length; l < h; l++)
                                ...
                                u = p.length; _ < u; _++) {
                                    ...
                                    i = -1,
                                    s = f = 0,
                                    g = A.length; 0 <= g ? f < g : f > g; s = 0 <= g ? ++f : --f)
                                        if (A[s][0] === o) {
                                            i = s;
                                            break
                                        }
                                    i === -1 ? (y = A.concat([[o, a]]),
                                    c.push(y)) : (E = A.slice(0),
                                    E.splice(i, 1),
                                    E.push([o, a]),
                                    c.push(A),
                                    c.push(E))
                ...
                l33t_match: function(e, t, n) {
                    ...
                    c = 0,
                    a = _.length; c < a && (d = _[c],
                    !this.empty(d)); c++)
                        for (g = this.translate(e, d),
                ...
                spatial_match_helper: function(e, t, n) {
                    ...
                    u = 0; u < e.length - 1; )
                        ...
                        l = null,
                        m = 0,
                        g = "qwerty" !== n && "dvorak" !== n || !this.SHIFTED_RX.exec(e.charAt(u)) ? 0 : 1; ; ) {
                            if (p = e.charAt(c - 1),
                            o = !1,
                            h = -1,
                            s = -1,
                ...
                repeat_match: function(e) {
                    ...
                    c = /(.+?)\1+/g,
                    l = /^(.+?)\1+$/,
                    u = 0; u < e.length && (a.lastIndex = c.lastIndex = u,
                    s = a.exec(e),
                    _ = c.exec(e),
                    null != s); )
                        s[0].length > _[0].length ? (f = s,
                        i = l.exec(f[0])[1]) : (f = _,
                        i = f[1]),
                ...
                sequence_match: function(e) {
                    ...
                    for (u = function(t) {
                        return function(n, r, i) {
                            var a, s, o, u;
                            if ((r - n > 1 || 1 === Math.abs(i)) && 0 < (a = Math.abs(i)) && a <= t.MAX_DELTA)
                                return u = e.slice(n, +r + 1 || 9e9),
                                /^[a-z]+$/.test(u) ? (s = "lower",
                                o = 26) : /^[A-Z]+$/.test(u) ? (s = "upper",
                                o = 26) : /^\d+$/.test(u) ? (s = "digits",
                                o = 10) : (s = "unicode",
                                o = 26),
                                h.push({
                                    pattern: "sequence",
                    ...
                    a = null,
                    i = s = 1,
                    o = e.length; 1 <= o ? s < o : s > o; i = 1 <= o ? ++s : --s)
                ...
                date_match: function(e) {
                    ...
                    s = m = 0,
                    v = e.length - 4; 0 <= v ? m <= v : m >= v; s = 0 <= v ? ++m : --m)
                        for (o = A = I = s + 3,
                        R = s + 7; (I <= R ? A <= R : A >= R) && !(o >= e.length); o = I <= R ? ++A : --A)
                            if (L = e.slice(s, +o + 1 || 9e9),
                            f.exec(L)) {
                                for (r = [],
                                T = DATE_SPLITS[L.length],
                                E = 0,
                                c = T.length; E < c; E++)
                                    D = T[E],
                                    h = D[0],
                                    u = D[1],
                                    a = this.map_ints_to_dmy([parseInt(L.slice(0, h)), parseInt(L.slice(h, u)), parseInt(L.slice(u))]),
                                    null != a && r.push(a);
                                if (r.length > 0) {
                                    for (t = r[0],
                                    p = function(e) {
                    ...
                    for (s = q = 0,
                    j = e.length - 6; 0 <= j ? q <= j : q >= j; s = 0 <= j ? ++q : --q)
                        for (o = C = b = s + 5,
                        N = s + 9; (b <= N ? C <= N : C >= N) && !(o >= e.length); o = b <= N ? ++C : --C)
                            L = e.slice(s, +o + 1 || 9e9),
                            S = d.exec(L),
                            null != S && (a = this.map_ints_to_dmy([parseInt(S[1]), parseInt(S[3]), parseInt(S[4])]),
                            null != a && _.push({
                                pattern: "date",
                                token: L,
                                i: s,
                ...
                map_ints_to_dmy: function(e) {
                    ...
                    if (!(e[1] > 31 || e[1] <= 0)) {
                        ...
                        if (!(h >= 2 || 3 === o || p >= 2)) {
                            for (c = [[e[2], e.slice(0, 2)], [e[0], e.slice(1, 3)]],
                            u = 0,
                            i = c.length; u < i; u++)
                                if (_ = c[u],
                                g = _[0],
                                ...
                                DATE_MIN_YEAR <= g && g <= DATE_MAX_YEAR)
                                    return t = this.map_ints_to_dm(d),
                                    null != t ? {
                                        year: g,
                                        month: t.month,
                                        day: t.day
                            ...
                            a = c.length; l < a; l++)
                                ...
                                null != t)
                                    return g = this.two_to_four_digit_year(g),
                                    {
                                        year: g,
                                        month: t.month,
                                        day: t.day
        ...
        6: [function(require, module, exports) {
            ...
            scoring = {
                ...
                estimate_guesses: function(e, t) {
                    var r, n, s;
                    return null != e.guesses ? e.guesses : (s = 1,
                    e.token.length < t.length && (s = 1 === e.token.length ? MIN_SUBMATCH_GUESSES_SINGLE_CHAR : MIN_SUBMATCH_GUESSES_MULTI_CHAR),
                    r = {
                ...
                bruteforce_guesses: function(e) {
                    var t, r;
                    return t = Math.pow(BRUTEFORCE_CARDINALITY, e.token.length),
                    t === Number.POSITIVE_INFINITY && (t = Number.MAX_VALUE),
                    r = 1 === e.token.length ? MIN_SUBMATCH_GUESSES_SINGLE_CHAR + 1 : MIN_SUBMATCH_GUESSES_MULTI_CHAR + 1,
                    Math.max(t, r)
                },
                ...
                sequence_guesses: function(e) {
                    var t, r;
                    return r = e.token.charAt(0),
                    t = "a" === r || "A" === r || "z" === r || "Z" === r || "0" === r || "1" === r || "9" === r ? 4 : r.match(/\d/) ? 10 : 26,
                    e.ascending || (t *= 2),
                    t * e.token.length
                },
                MIN_YEAR_SPACE: 20,
                ...
                regex_guesses: function(e) {
                    ...
                    switch (e.regex_name) {
                    case "recent_year":
                        return r = Math.abs(parseInt(e.regex_match[0]) - this.REFERENCE_YEAR),
                        r = Math.max(r, this.MIN_YEAR_SPACE)
                    }
                },
                date_guesses: function(e) {
                    var t, r;
                    return r = Math.max(Math.abs(e.year - this.REFERENCE_YEAR), this.MIN_YEAR_SPACE),
                    t = 365 * r,
                    e.separator && (t *= 4),
                    t
                },
                ...
                spatial_guesses: function(e) {
                    ...
                    for ("qwerty" === (E = e.graph) || "dvorak" === E ? (l = this.KEYBOARD_STARTING_POSITIONS,
                    s = this.KEYBOARD_AVERAGE_DEGREE) : (l = this.KEYPAD_STARTING_POSITIONS,
                    s = this.KEYPAD_AVERAGE_DEGREE),
                    a = 0,
                    t = e.token.length,
                    S = e.turns,
                    u = _ = 2,
                    c = t; 2 <= c ? _ <= c : _ >= c; u = 2 <= c ? ++_ : --_)
                        for (o = Math.min(S, u - 1),
                        i = h = 1,
                        g = o; 1 <= g ? h <= g : h >= g; i = 1 <= g ? ++h : --h)
                            a += this.nCk(u - 1, i - 1) * l * Math.pow(s, i);
                    if (e.shifted_count)
                        if (r = e.shifted_count,
                        ...
                        0 === r || 0 === n)
                            ...
                            for (A = 0,
                            u = p = 1,
                            f = Math.min(r, n); 1 <= f ? p <= f : p >= f; u = 1 <= f ? ++p : --p)
                                A += this.nCk(r + n, u);
                            a *= A
                        }
                    return a
                ...
                uppercase_variations: function(e) {
                    ...
                    c.match(this.ALL_LOWER) || c.toLowerCase() === c)
                        return 1;
                    for (_ = [this.START_UPPER, this.END_UPPER, this.ALL_UPPER],
                    u = 0,
                    a = _.length; u < a; u++)
                        if (h = _[u],
                        c.match(h))
                    ...
                    E = 0,
                    s = i = 1,
                    o = Math.min(r, t); 1 <= o ? i <= o : i >= o; s = 1 <= o ? ++i : --i)
                        E += this.nCk(r + t, s);
                    return E
                },
        ...
        7: [function(require, module, exports) {
            ...
            time_estimates = {
                ...
                guesses_to_score: function(e) {
                    var t;
                    return t = 5,
                    e < 1e3 + t ? 0 : e < 1e6 + t ? 1 : e < 1e8 + t ? 2 : e < 1e10 + t ? 3 : 4
                },
                display_time: function(e) {
                    ...
                    c = 12 * a,
                    n = 100 * c,
                    u = e < 1 ? [null, "less than a second"] : e < i ? (t = Math.round(e),
                    [t, t + " second"]) : e < r ? (t = Math.round(e / i),
                    [t, t + " minute"]) : e < s ? (t = Math.round(e / r),
                    [t, t + " hour"]) : e < a ? (t = Math.round(e / s),
                    [t, t + " day"]) : e < c ? (t = Math.round(e / a),
                    [t, t + " month"]) : e < n ? (t = Math.round(e / c),
                    [t, t + " year"]) : [null, "centuries"],
                    o = u[0],
                    _ = u[1],
                    null != o && 1 !== o && (_ += "s"),
                    _
